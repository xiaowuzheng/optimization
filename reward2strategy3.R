#reward function 2 with transaction costs #strategy 3
...
#-----------------------------------------------------------------------------------------------------------------#
RES.model2.R2.S3<-function(ntime,gammm,thet,intervallength,sam){
  RES.list<-list()
...
#-----------------------------------------------------------------------------------------------------------------#
AW.model2.R2.S3<-function(ga,the,totalinte,intelength,whichsam){
  res.list<-list()
  res<-matrix(0,nrow=100,ncol=10)
  res.inter<-RES.model2.R2.S3(totalinte,ga,the,intelength,whichsam)
...
#-----------------------------------------------------------------------------------------------------------------#
AV.model2.R2.S3<-function(L,paragamma,paramthet,nosample){
  ...
  for (i in 1:nosample){
    AW.sam<-AW.model2.R2.S3(paragamma,paramthet,100/L,L,i)
...
#########################################################################################################
#--------------gamma=20, theta=60-----------------#
model2.L20.R2.S3.theta1<-AV.model2.R2.S3(L=20,paragamma=0.1,paramthet=1,nosample=1000)
#--------------gamma=20, theta=40-----------------#
model2.L20.R2.S3.theta2<-AV.model2.R2.S3(L=20,paragamma=0.1,paramthet=0.8,nosample=1000)
#--------------gamma=20, theta=30-----------------#
model2.L20.R2.S3.theta3<-AV.model2.R2.S3(L=20,paragamma=0.1,paramthet=0.5,nosample=1000)
#--------------gamma=20, theta=20-----------------#
model2.L20.R2.S3.theta4<-AV.model2.R2.S3(L=20,paragamma=0.1,paramthet=0.3,nosample=1000)
#--------------gamma=20, theta=10-----------------#
model2.L20.R2.S3.theta5<-AV.model2.R2.S3(L=20,paragamma=0.1,paramthet=0.1,nosample=1000)
#--------------gamma=20, theta=5-----------------#
model2.L20.R2.S3.theta6<-AV.model2.R2.S3(L=20,paragamma=0.1,paramthet=0,nosample=1000)

#---------------L=20--------------------#
per.model2.L20.R2.S3.theta1<-performance(model2.L20.R2.S3.theta1[[1]])
per.model2.L20.R2.S3.theta2<-performance(model2.L20.R2.S3.theta2[[1]])
per.model2.L20.R2.S3.theta3<-performance(model2.L20.R2.S3.theta3[[1]])
per.model2.L20.R2.S3.theta4<-performance(model2.L20.R2.S3.theta4[[1]])
per.model2.L20.R2.S3.theta5<-performance(model2.L20.R2.S3.theta5[[1]])
per.model2.L20.R2.S3.theta6<-performance(model2.L20.R2.S3.theta6[[1]])


#--------------------------------ggplot for profit and loss----------------------------#
pandl.R2.S3<-c(colMeans(model2.L20.R2.S3.theta1[[1]])/100000-rep(1,100),colMeans(model2.L20.R2.S3.theta2[[1]])/100000-rep(1,100),colMeans(model2.L20.R2.S3.theta3[[1]])/100000-rep(1,100),colMeans(model2.L20.R2.S3.theta4[[1]])/100000-rep(1,100),colMeans(model2.L20.R2.S3.theta5[[1]])/100000-rep(1,100),colMeans(model2.L20.R2.S3.theta6[[1]])/100000-rep(1,100))#,colMeans(model2.L20.R2.S3.theta7[[1]])/100000-rep(1,100),colMeans(model2.L20.R2.S3.theta8.1[[1]])/100000-rep(1,100))
para.R2.S3<-c(rep("1",100),rep("0.8",100),rep("0.5",100),rep("0.3",100),rep("0.1",100),rep("0",100))
df.R2.S3<-data.frame(time=rep(1:100,6),return=(pandl.R2.S3),theta=para.R2.S3)
ggplot(data=df.R2.S3,aes(x=time,y=return))+geom_line(aes(colour=theta))+ scale_colour_hue()
